...
class AccountMove(models.Model):
    ...
    def _compute_qr_code(self):
        for move in self:
            qr_dict = {
                "rnc_emisor": move.company_id.vat,
                "rnc_comprador": move.partner_id.vat or "",
                "ncf": "E310000000000001",
                "monto_total": str(move.amount_total),
                "fecha_emision": str(move.invoice_date),
                "track_id": move.dgii_track_id or "",
                "codigo_seguridad": "WkT35a",
            }
